...
def time_check():
    ...
    if TOD >= 7:
        ...
        sleep()
def main_loop():
    global materials, TOD, score, day, kill, rng
    while kill is False:
        time_check()
        check_fire()
        checkrecources()
        print('what are you doing.')
        print("wood: " + str(materials[0]) + " food: " + str(materials[1]))
        question = str(input('> '))
        ...
        elif question == "pooping":
            print("-40 from food and wood. you got diarea?")
            modify_materials('food', (materials[1] - 40))
            modify_materials('wood', (materials[0] - 40))
        elif question == "set_food()" and py_cheats == 1:
            modify_materials('food', int(input('input_number> ')))
        elif question == "set_wood()" and py_cheats == 1:
            modify_materials('wood', int(input('input_number> ')))
        elif question == "set_fire()" and py_cheats == 1:
            modify_materials('fire', int(input('input_number> ')))
        elif question == "set_location()" and py_cheats == 1:
            modify_materials('fire', input('input_string/location> '))
        elif question == "py_cheats 1":
            py_cheats = 1
        elif question == "py_cheats 0":
            py_cheats = 0
        else:
